...
> 최종 업데이트: 2026-04-04 (JWT 자동 갱신, 스와이프 개선, 알림 메모 기능, 보안 강화 반영)
...
| 알림 | 트리거 | 대상 |
|------|--------|------|
| 안전점검 알림 | 매월 4/14/24일 (당일) 또는 3/13/23일 (전날) | 비교대 직원 |
| 알림문서 발송 | 특정 메모 등록 후 +13/+14일 | 전체 |
| 사용자 정의 알림 | `알림:` 메모 등록된 날짜 당일/전날 접속 | 전체 |
